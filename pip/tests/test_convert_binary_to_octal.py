...
from opentoolshub.convert_binary_to_octal import ConvertBinaryToOctal
...
class TestConvertBinaryToOctal(unittest.TestCase):
    def test_convert_binary_to_octal(self):
        ...
        self.assertEqual(ConvertBinaryToOctal("1001"), 9)
        self.assertEqual(ConvertBinaryToOctal("1010"), 10)
